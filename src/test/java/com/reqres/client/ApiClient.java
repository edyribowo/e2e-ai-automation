...
/**
 * Thin Rest Assured wrapper. Builds each request from the current
 * {@link TestContext} (API key, body, content-type) and keeps the HTTP
 * mechanics out of the step definitions. Injected by PicoContainer.
 */
public class ApiClient {
    ...
    /** Issues a one-off GET that ignores scenario body state (used for follow-up reads). */
